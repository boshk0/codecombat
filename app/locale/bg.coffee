...
#  ozaria_home:
subtitle: "Компютърни науки, които завладяват"
heading_subtitle: "Приключение с програмиране за студенти и Вашето готово решение за преподаване на компютърни науки."
item_list_p: "Опитайте Глава 1 безплатно днес!"
engaging_heading_corner: "Решение за мотивиране на студентите и подкрепа за учителите"
engaging_row1_h2: "Лесно внедряване"
engaging_row1_p: "Дори без опит в програмирането, Вие можете да преподавате пълна програма по компютърни науки с Ozaria. Нашият готов план за уроци и интуитивния дашборд ще Ви предоставят инструментите, от които се нуждаете, за да сте готови да преподавате от първия ден."
engaging_row2_h2: "Завладяваща игра"
engaging_row2_p: "Студентите се потапят в приключенска игра, в която техните познания по компютърни науки се развиват заедно със сюжета. В тази завладяваща образователна среда, студентите изграждат реални умения чрез игра."
engaging_row3_h2: "Учебен план, съответстващ на стандартите"
engaging_row3_p: "Ozaria отговаря на стандартите на CSTA и ISTE, което Ви позволява да преподавате с увереност, докато Вашите студенти усвояват основни понятия по компютърни науки, развиват умения за компютърно мислене и разбират релевантността на компютърните науки за ежедневието си."
pd_blurb: "Научете уменията за ефективно преподаване на компютърни науки с нашия самостоятелен, акредитиран от CSTA курс. Натрупайте до 40 кредитни часа по всяко време, от всяко устройство."
